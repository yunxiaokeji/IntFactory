...
namespace IntFactoryBusiness
{
    public class TaskBusiness
    {
        ...
        /// <returns></returns>
        public static List<TaskEntity> GetTasks(string keyWords, string ownerID, int isParticipate, int status, int finishStatus, int invoiceStatus,
            ...
            int pageSize, int pageIndex, ref int totalCount, ref int pageCount) 
        {
            ...
            DataTable dt = TaskDAL.BaseProvider.GetTasks(keyWords, ownerID,isParticipate, status, finishStatus, invoiceStatus,
