define(function (require, exports, module) {
    ...
    ObjectJS.bindEvent = function () {
        ...
        $("#updateObject").click(function () {
            var _this = $(this);
            Global.post("/System/GetRoleByID", { id: _this.data("id") }, function (data) {
    ...
    ObjectJS.getList = function () {
        ...
        Global.post("/System/GetRoles", {}, function (data) {
    ...
    ObjectJS.bindList = function (items) {
        ...
        if (items.length > 0) {
            doT.exec("template/System/roles.html", function (template) {
    ...
    ObjectJS.bindPermissionEvent = function (roleid) {
        $("#savePermission").click(function () {
            ...
            Global.post("/System/SaveRolePermission", {
                roleid: roleid,
                permissions: menus
            }, function (data) {
                if (data.status) {
