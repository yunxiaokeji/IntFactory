define(function (require, exports, module) {
    ...
    ObjectJS.init = function (type,orderID) {
        ...
        //处理未完成的订单
        if (orderID != "") {
            ObjectJS.RealAmount = $("#pay-amount").html();
        }
        else {
            _self.getList();
        }
        ...
        Global.post("/Auction/GetBestWay",
            ...
            function (data) {
                ...
                for (var i = 0; len = data.Items.length, i < len; i++) {
                    ...
                    var productHtml = '';
                    if (item.count > 1) {
                        productHtml = '<span class="product-count">×' + item.count + '</span><span class="product-select">√</span>';
                    }
                    else {
                        productHtml = '<span class="product-select">√</span>';
                    }
    ...
    //完成支付
    ObjectJS.finishPay = function (result) {
        Easydialog.close();
